...
export async function POST(request: Request) {
  try {
    ...
    const { action, leadIds, status, assignedToId } = body;
    ...
    switch (action) {
      case "updateStatus":
        ...
        return NextResponse.json({
          ...
          message: `${result.count} leadova ažurirano`,
        });
      ...
      case "assign":
        ...
        return NextResponse.json({
          success: true,
          updated: result.count,
          message: `${result.count} leadova dodijeljeno`,
        });
      ...
      case "delete":
        ...
        return NextResponse.json({
          ...
          message: `${result.count} leadova obrisano`,
        });
